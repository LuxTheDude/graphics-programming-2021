...
const std::string path = "C:/Users/lux_-/Desktop/CGPRO - Labs/graphics-programming-2021/exercises/exercise_2/exercise_2_1/";
...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader(path + "shaders/shader.vert", path + "shaders/shader.frag");
